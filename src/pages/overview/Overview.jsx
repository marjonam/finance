  ...
  return (
    <div className="overview">
      ...
      <div className="overview-bottom">
        <div className="overview-bottom_wrappers">
          <div className="overview-pots">
            ...
            <div className="overview-pots-bottom">
              <div className="overview-pots-bottom-left">
                <svg
                  fill="none"
                  height="22"
                  viewBox="0 0 18 22"
                ...
                <span className="wrapper">
                  <span className="caption">Total Saved</span>
                  <span className="overview-pots-bottom_title">$850</span>
                </span>
              </div>
              <ul className="overview-pots-bottom_list">
                {data &&
                  data.pots.slice(0, 4).map((item) => {
                    return (
                      <li
                        key={item.id}
                        className="overview-pots-bottom_list-item"
                      >
                        <span
                          style={{
                            backgroundColor: item.theme,
                          }}
                          className="overview-pots-bottom_list-item_shape"
                        ></span>
                        <div>
                          <span>{item.name}</span>
                          <h6>${item.total}</h6>
            ...
            <ul className="overview-transactions-list">
              {data &&
                data.transactions.slice(0, 5).map((item) => {
                  ...
                  return (
                    <li key={item.id} className="overview-transaction">
                      <div className="overview-transaction-user">
                        <img src={item.avatar} alt={item.name + "avatar"} />
                        <h2>{item.name}</h2>
                      </div>
                      <div className="overview-transaction-captions">
                        <h6
        ...
        <div className="overview-bottom_wrappers">
          ...
          <div className="overview-recurring">
            <div className="overview-section-top">
